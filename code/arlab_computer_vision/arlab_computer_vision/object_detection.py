...
class ObjectDetection(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(CameraInfo, '/camera/aligned_depth_to_color/camera_info', self.camera_info_cb, queue_size=1)
    ...
    def process_data(self, rgb_msg, depth_msg):
        ...
        for i, mask in enumerate(masks_np):
            ...
            print(f"[Maske {i}] Klasse: {class_name} ({class_id}) → {len(points_3d)} 3D-Punkte extrahiert.")
