...
def transform_pose(tf_buffer, pose, stamp, ref_frame):
    ...
    pose_stamped.header.frame_id = "camera_link" #ref_frame
    ...
    transformed_pose = do_transform_pose(pose, transform_stamped)
...
def transform_bBox(tf_buffer, bBox, stamp, ref_frame):
    ...
    # Update bBox with transformed points
