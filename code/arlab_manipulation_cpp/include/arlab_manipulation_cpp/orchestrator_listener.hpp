...
// and hand motion components as well as the force stream and force monitor
// switches, and delegates job execution to JobRunner.
// -----------------------------------------------------------------------------

#ifndef ARLAB_MANIPULATION_CPP_ORCHESTRATOR_LISTENER_HPP_
#define ARLAB_MANIPULATION_CPP_ORCHESTRATOR_LISTENER_HPP_
...
private:
   ...
   * @return  ACCEPT_AND_EXECUTE if cmd is non-empty, REJECT otherwise.
   */
  ...
  std::unique_ptr<ForceMonitorSwitch> monitor_switch_;
  std::unique_ptr<JobRunner> runner_;
};

#endif  // ARLAB_MANIPULATION_CPP_ORCHESTRATOR_LISTENER_HPP_
