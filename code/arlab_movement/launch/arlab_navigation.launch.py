...
def generate_launch_description():
    ...
    param_file = PathJoinSubstitution([package_dir, "params", "arlab_navigation_params.yaml"])
    ...
    map_save_publisher = Node(
        package="arlab_movement", executable="map_save_publisher", name="map_save_publisher", output="screen", parameters=[param_file]
    )
