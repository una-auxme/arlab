...
class DatabaseNode(Node):
    ...
    def __init__(self):
        ...
        entity_callback_group = ReentrantCallbackGroup()
        shape_callback_group = ReentrantCallbackGroup()
        door_open_callback_group = ReentrantCallbackGroup()
        door_width_callback_group = ReentrantCallbackGroup()
        pose_and_reference_callback_group = ReentrantCallbackGroup()
        description_callback_group = ReentrantCallbackGroup()
        self.srv = self.create_service(
            GetEntities,
            "/get_entities_callback",
        ...
        self.srv = self.create_service(
            ...
            callback_group=shape_callback_group,
        )
        ...
        self.srv = self.create_service(
            ...
            callback_group=door_open_callback_group,
        )
        ...
        self.srv = self.create_service(
            ...
            callback_group=door_width_callback_group,
        )

        self.srv = self.create_service(
            GetPoseAndReference,
            "/get_pose_and_reference",
            self.get_pose_and_reference,
            callback_group=pose_and_reference_callback_group,
        )
        ...
        self.srv = self.create_service(
            ...
            callback_group=description_callback_group,
        )
    ...
    async def get_pose_and_reference(
        self, request: GetEntities.Request, response: GetEntities.Response
    ):
        ### TODO implement the function once the database exists
        return response
