...
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| Jetson 1        | - Physical control: Powertrain and Manipulator control units<br>- LIDAR (maybe » Jetson 3)<br>- 3x RGBD Camera (maybe » Jetson 3) | - pkg: arlab_computer_vision<br>- pkg: arlab_manipulation<br>- pkg: arlab_movement<br>- (external perception pkgs)<br>- (external hardware driver pkgs) | - ubuntu 24.04<br>- docker<br>--- arlab_docker image<br>--- (external docker images)<br>- robot hardware drivers                             |
| Jetson 2        | - HRI screen<br>- Speaker<br>- Microphone                                                                                         | - pkg: arlab_speech_controller<br>- pkg: arlab_vizbox<br>- pkg: decision_making<br>- pkg: knowledge<br>- node: global_safety                            | - ubuntu 24.04<br>- docker<br>--- arlab_docker image<br>- audio drivers<br>--- pipewire + plugins<br>----- rnnoise<br>----- echo suppression |
...
TODO: Usage? Or should usage be part of a pkg-level README?
